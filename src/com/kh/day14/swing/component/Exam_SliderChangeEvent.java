...
public class Exam_SliderChangeEvent extends JFrame{
	
	private JLabel colorLabel;
	private JSlider [] sliders;
	
	public Exam_SliderChangeEvent() {
		...
		for(int i = 0; i < sliders.length; i++) {				// 수평모양으로 최소0, 최대255, 시작값128 슬라이더를 만듬
			...
			sliders[i].addChangeListener(new ChangeListener() {
				...
				public void stateChanged(ChangeEvent e) {
					int r = sliders[0].getValue();				// 슬라이더의 해당값(숫자)
