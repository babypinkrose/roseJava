...
public class MemberView {
	...
	public void StartMemberProgram() {
		...
		while(true) {
			...
			case 1 : 
				...
				break;
			case 2 : 
				name = this.inputMemberName(); // 수정할 데이터의 이름을 입력받음
	...
	public int printMenu() {
		...
		System.out.println("4. 회원 정보 검색(이름)");
	...
	public void printOneMember(Member member) {
		...
		System.out.println("===== 회원 정보 검색(이름) =====\n");
