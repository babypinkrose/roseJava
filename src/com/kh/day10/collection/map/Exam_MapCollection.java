...
public class Exam_MapCollection {
	...
	public static void main(String[] args) {
		...
		stdMap.put("one", new Student("로즈", 90, 80));
		stdMap.put("two", new Student("타이타닉", 44, 66));
	...
	public void mapExample1() {
		...
		System.out.println("061을 누르면 전라도가 나옵니다 : " + map.get("061"));
		System.out.println("053을 누르면 대구가 나옵니다 : " + map.get("053"));
